...
HD_PWD='C:/Vivado_Projects/i2c_wrapper/i2c_wrapper/i2c_wrapper.runs/rom_address_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_address.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_address.tcl
