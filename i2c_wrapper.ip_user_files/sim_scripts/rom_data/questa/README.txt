...
#
# Generated by export_simulation on Tue Jul 16 13:52:52 +0530 2019
#
################################################################################
...
'-reset_run' switch to the './rom_data.sh' script.

./rom_data.sh -reset_run
...
./rom_data.sh -noclean_files

For more information on the script, please type './rom_data.sh -help'.
